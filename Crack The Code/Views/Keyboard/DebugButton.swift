...
//            state.dispatch(addCharacter(char: "W"))
//            state.dispatch(addCharacter(char: "I"))
//            state.dispatch(addCharacter(char: "N"))
//            state.dispatch(addCharacter(char: "G"))
//            state.dispatch(submitGuess())
//            state.dispatch(addCharacter(char: "P"))
//            state.dispatch(addCharacter(char: "L"))
